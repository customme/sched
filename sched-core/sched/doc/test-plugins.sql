...
INSERT INTO `t_db_conn` (`create_by`, `create_date`, `db_name`, `type_id`, `username`, `password`, `hostname`, `port`) VALUES 
(@CREATE_BY, NOW(), 'ad_dw', 1, 'root', 'mysql', '10.10.10.64', 3306);

INSERT INTO `t_db_conn` (`create_by`, `create_date`, `db_name`, `type_id`, `username`, `password`, `hostname`, `port`) VALUES 
(@CREATE_BY, NOW(), 'ad_dw1', 1, 'root', 'mysql', '10.10.10.64', 3306);
SET @ad_db_id1=(SELECT @@IDENTITY);

INSERT INTO `t_db_conn` (`create_by`, `create_date`, `db_name`, `type_id`, `username`, `password`, `hostname`, `port`) VALUES 
(@CREATE_BY, NOW(), 'ad_dw2', 1, 'root', 'mysql', '10.10.10.64', 3306);
...
INSERT INTO `t_task` (`create_by`, `create_date`, `name`, `task_group`, `type_id`, `task_status`, `task_cycle`, `cluster_id`, `server_id`, `start_time`) VALUES 
(@CREATE_BY, NOW(), 'flume消费kafka里的访问日志', @TASK_GROUP, 17, @TASK_STATUS, @TASK_CYCLE, @CLUSTER_ID, @SERVER_ID, NOW());
SET @task_id=(SELECT @@IDENTITY);
INSERT INTO `t_task_ext` (`create_by`, `create_date`, `task_id`, `prop_name`, `prop_value`) VALUES 
...
INSERT INTO `t_task` (`create_by`, `create_date`, `name`, `task_group`, `type_id`, `task_status`, `task_cycle`, `cluster_id`, `server_id`, `start_time`) VALUES 
(@CREATE_BY, NOW(), 'flume接收访问日志并写入hdfs', @TASK_GROUP, 17, @TASK_STATUS, @TASK_CYCLE, @CLUSTER_ID, 4, NOW());
SET @task_id=(SELECT @@IDENTITY);
INSERT INTO `t_task_ext` (`create_by`, `create_date`, `task_id`, `prop_name`, `prop_value`) VALUES 
